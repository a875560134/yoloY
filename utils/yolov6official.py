...
class ComputeLoss_meituanv6:
    ...
    def __init__(self,
        ...
        self.iou_loss = IOUloss_meituanv6(iou_type=iou_type)
    ...
    def __call__(
        ...
        global l1_target, obj_target, reg_target, cls_target
        ...
        return total_losses, torch.cat((self.reg_weight * loss_iou, loss_l1, loss_obj)).detach()
    ...
    def get_assignments(
        ...
        # cost
        pair_wise_ious = pairwise_bbox_iou(gt_bboxes_per_image, bboxes_preds_per_image)
...
class IOUloss_meituanv6:
    ...
    def __call__(self, box1, box2):
        ...
        """
        global b2_y1, b1_y1, b2_y2, b1_y2, b2_x1, b1_x1, b2_x2, b1_x2
        box2 = box2.T
